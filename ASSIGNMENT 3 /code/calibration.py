...
def main():
  ...
  print(f'Reprojection error before optimization: {np.linalg.norm(ImageResiduals(P_hat, normalized_points2D, normalized_points3D))**2}') #LINE ADDED TO COMPLETE THE REPORT
  # TODO
